...
import net.fekepp.roest.AbstractController;
...
public class BaseJettyController extends AbstractController {
	 ...
	 * 
	 * Jetty 9: ServerConnector serverConnector = new ServerConnector(server);
	 * 
	 * Jetty 8: SocketConnector serverConnector = new SocketConnector();
	 */
	private SocketConnector serverConnector = new SocketConnector();
	...
	public SocketConnector getServerConnector() {
		return serverConnector;
	}

	public void setServerConnector(SocketConnector serverConnector) {
